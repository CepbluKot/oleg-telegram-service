...
class Chat(base.TelegramObject):
    ...
    def get_mention(self, name=None, as_html=True) -> base.String:
        if (
            ...
            and self.bot.parse_mode.lower() == "html"
        ):
            as_html = True
    ...
    async def set_administrator_custom_title(
        self, user_id: base.Integer, custom_title: base.String
    ) -> base.Boolean:
        """
        ...
        return await self.bot.set_chat_administrator_custom_title(
            chat_id=self.id, user_id=user_id, custom_title=custom_title
        )
    ...
    async def pin_message(
        ...
        return await self.bot.pin_chat_message(
            self.id, message_id, disable_notification
        )
    ...
    async def get_administrators(
        self,
    ) -> typing.List[typing.Union[ChatMemberOwner, ChatMemberAdministrator]]:
        """
    ...
    async def set_sticker_set(self, sticker_set_name: base.String) -> base.Boolean:
        ...
        return await self.bot.set_chat_sticker_set(
            self.id, sticker_set_name=sticker_set_name
        )
...
class ChatType(helper.Helper):
    ...
    SUPER_GROUP: DeprecatedReadOnlyClassVar[
        ChatType, helper.Item
    ...
    @classmethod
    @deprecated(
        "This filter was moved to ChatTypeFilter, and will be removed in aiogram v3.0"
    )
