...
class Message(base.TelegramObject):
    ...
    message_auto_delete_timer_changed: MessageAutoDeleteTimerChanged = fields.Field(
        base=MessageAutoDeleteTimerChanged
    )
    ...
    proximity_alert_triggered: ProximityAlertTriggered = fields.Field(
        base=ProximityAlertTriggered
    )
    ...
    voice_chat_participants_invited: VoiceChatParticipantsInvited = fields.Field(
        base=VoiceChatParticipantsInvited
    )
    ...
    video_chat_participants_invited: VideoChatParticipantsInvited = fields.Field(
        base=VideoChatParticipantsInvited
    )
