...
def _ensure_loop(x: "asyncio.AbstractEventLoop"):
    assert isinstance(x, asyncio.AbstractEventLoop), (
...
class Dispatcher(DataMixin, ContextInstanceMixin):
    ...
    def __init__(
        ...
        self.chat_join_request_handlers = Handler(
            self, middleware_key="chat_join_request"
        )
    ...
    async def process_update(self, update: types.Update):
        ...
        try:
            ...
            if update.chat_join_request:
                ...
                return await self.chat_join_request_handlers.notify(
