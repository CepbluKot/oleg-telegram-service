...
class WebhookRequestHandler(web.View):
    ...
    def respond_via_request(self, task):
        ...
        try:
            ...
            loop.create_task(
                dispatcher.errors_handlers.notify(
                    dispatcher, types.Update.get_current(), e
                )
            )
        else:
            response = self.get_response(results)
...
class ReplyToMixin:
    ...
    def to(
        self,
        target: typing.Union[
            types.Message, types.Chat, types.base.Integer, types.base.String
        ],
    ):
        """
        Send to chat
...
class ForwardMessage(
    BaseResponse, ReplyToMixin, DisableNotificationMixin, ProtectContentMixin
):
    """
...
class SendMediaGroup(
    ...
    def attach_video(
        ...
        :return: self
        """
        self.media.attach_video(
            video, caption, width=width, height=height, duration=duration
        )
        return self
