...
from bot_elements.getters.services_getters import get_all_services_names, get_service_days, get_service_weeks
from bot_elements.output.services_output import output_chosen_service_data
...
async def choose_service_final(message: types.Message, state: FSMContext):
    ...
    output_chosen_service_data(service_name=service_name, service_week=service_week, service_day=service_day, user_id=message.chat.id)
