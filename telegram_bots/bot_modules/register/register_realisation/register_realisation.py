...
from telegram_bots.bot_modules.register.data_structures import DatabaseUser


class RegisterForUniversityRealisation(RegisterForUniversityInterface):
...
class RegisterForCustomersRealisation(RegisterForCustomersInterface):
    def add_user(self, user: User):
        register_repository_abs.add_user(user=user)
...
class RegisterForCustomersInDatabaseRealisation(RegisterForCustomersInterface):
    ...
    def update_user_data(self, new_user_data: DatabaseUser):
        register_repository_abs.update_user_data(user_data=new_user_data)
