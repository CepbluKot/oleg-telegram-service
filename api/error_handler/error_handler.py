...
def handle_error_async_api(response: ClientResponse, response_text: str):
    ...
    elif 'this event alredy exist' in response_text:
        error_info.user_already_exists = True
        error_info.has_error = True

    elif 'NOT FIND USERS' in response_text:
        error_info.user_not_found = True
        error_info.has_error = True

    elif 'not find' in response_text:
...
def handle_error_sync_api(response: Response):
    ...
    elif 'this event alredy exist' in response.text:
        error_info.user_already_exists = True
        error_info.has_error = True
